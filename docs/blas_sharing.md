...
* [shaders/traversal_init_blas_reuse.comp.glsl](../shaders/traversal_init_blas_reuse.comp.glsl): Reads the instance LoD classification from `shaderio::InstanceBuildInfo` and the corresponding `shaderio::GeometryBuildInfo` to test which category an instance belongs to.
